...
@if(isset($room->image))
    <div class="col-md-12">
        <img id="image" src="{{url($room->image)}}" style="width: 100px;border-radius: 50px;">
    </div>
@else
    <div class="col-md-12">
...
<div class="form-group py-1 col-md-12">
    ...
    <br>
    {!! Form::file('image',['class'=>'form-control col','placeholder'=>__("Room image"),'onchange'=>"loadSliderImage(room)"]) !!}
