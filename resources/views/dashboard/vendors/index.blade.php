...
@section('title'){!! __('Vendor') !!}@endsection
...
@endsection
@section('btn')
        @include('dashboard.layouts.partials._add_icon',['route'=>'vendors','name'=>__('Add new vendor')])
@endsection
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <div class="row">
                                @include('dashboard.vendors.partials._form_filter')
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary   waves-effect waves-light">{{__('Filter')}}</button>
                                    <a href="{{route('dashboard.vendors.index')}}" class="  ml-1 btn btn-warning  waves-effect waves-light">{{__('Reset filter')}}</a>
                                </div>
                            </div>
                            {!! Form::close() !!}
                        </div>
