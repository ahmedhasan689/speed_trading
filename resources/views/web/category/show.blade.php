<x-front-layout title="{{ $category->getTranslation('name', app()->getLocale()) }}">
        ...
        <div class="container">
            <div class="rounded-4 py-5 bg-light d-flex align-items-center justify-content-around flex-column flex-md-row shadow-sm">
                <div class="page-title ms-5 position-relative">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('category.show', ['id' => $category->id]) }}" class="text-color text-decoration-none">
                                    {{ $category->getTranslation('name', 'ar') }}
                                </a>
                            </li>
                        </ol>
                ...
                <div class="page-img-hero">
                    <img src="{!! url('/').'/'.$category->image !!}" class="img-fluid" alt="distributers">
                </div>
            </div>
        </div>
    </section>
                ...
                if( $(this).hasClass('active') ){
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.ajax({
                                url: "{{ route('category.show', ['id' => $category->id]) }}",
                            }).done(function (data) {
